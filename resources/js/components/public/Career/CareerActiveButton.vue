...
<template>
    ...
    >
        <div
            class="outline-border dark:border-atomic-tangerine-600/30 flex size-20 shrink-0 items-center justify-center rounded-xl bg-white p-2 outline-1 dark:bg-white"
        >
