...
<template>
    <a
        ...
        class="border-border flex h-8 flex-shrink-0 items-center justify-center gap-3 rounded-full bg-white px-4 text-black no-underline border-1 focus:border-none"
        :class="{
