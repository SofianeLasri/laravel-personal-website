...
<template>
    <a
        ...
        class="outline-border flex h-8 flex-shrink-0 items-center justify-center gap-3 rounded-full bg-white px-4 text-black no-underline outline-1 focus:outline-none"
        :class="{
