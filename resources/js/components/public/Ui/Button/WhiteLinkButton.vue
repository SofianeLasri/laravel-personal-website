...
<template>
    <a
        ...
        class="border-border flex h-12 flex-shrink-0 items-center justify-center gap-3 rounded-full border-1 bg-white px-6 text-black no-underline focus:border-none dark:bg-gray-990 dark:text-gray-100"
        :class="{
