...
/**
 * Generic service for duplicating content blocks
 * Used by both blog posts and creations
 */
class ContentDuplicationService
{
     ...
     *
     * @param  Collection<int, mixed>  $originalContents  Collection of content records with content_type and content properties
     ...
     */
    public function duplicateTranslationKey(TranslationKey $originalTranslationKey): TranslationKey
    {
