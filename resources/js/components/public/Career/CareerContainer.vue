...
<template>
    <div class="relative inline-flex flex-col items-center justify-start gap-8 self-stretch">
        ...
        <div class="flex flex-col items-start justify-start gap-8 self-stretch lg:flex-row">
            ...
            >
                <div
                    class="action-container-inner-shadow inline-flex w-full flex-col items-start justify-start rounded-2xl border bg-white dark:bg-gray-900"
                >
                    ...
                    <!-- Content -->
                    <div
                        class="z-10 flex grow flex-col items-start justify-start gap-6 self-stretch rounded-2xl border-t-1 bg-white p-4 lg:gap-8 lg:p-8 dark:bg-gray-900"
                    >
            ...
            >
                <div
                    class="action-container-inner-shadow flex w-full items-center justify-center rounded-2xl border bg-white p-4 lg:p-8 dark:bg-gray-900"
                >
