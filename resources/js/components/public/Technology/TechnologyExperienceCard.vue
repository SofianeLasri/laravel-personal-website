        ...
        <div class="flex grow flex-col items-start justify-between gap-4 self-stretch rounded-2xl bg-white px-4 py-6 dark:bg-gray-950">
            <div class="flex flex-col items-start justify-start gap-4">
                <div class="flex items-center justify-start gap-4">
                    <div
                        class="dark:from-atomic-tangerine-600/20 dark:border-atomic-tangerine-500/20 dark:group-hover:border-atomic-tangerine-500/30 flex size-12 items-center justify-center gap-2.5 rounded-lg border border-1 dark:bg-gradient-to-br dark:to-gray-800/60 dark:shadow-[inset_0_1px_0_0_rgba(247,142,87,0.1)]"
                    >
