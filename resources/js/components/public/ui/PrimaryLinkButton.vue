...
<template>
    <a
        ...
        class="flex h-12 flex-shrink-0 items-center justify-center gap-3 rounded-full bg-atomic-tangerine-400 px-6 text-white no-underline focus:outline-none"
        :class="{
            'cursor-pointer hover:bg-atomic-tangerine-600': !disabled && !loading,
