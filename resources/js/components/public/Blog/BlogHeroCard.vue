...
<template>
    <Link
        ...
        class="group no-glow flex cursor-pointer flex-col gap-6 transition-transform hover:scale-[1.01] lg:flex-row lg:items-center lg:gap-10"
    >
        <!-- Hero Image -->
        ...
        <div class="flex grow flex-col gap-4">
            <div class="flex flex-col gap-3">
                <!-- Title -->
                <h4 class="text-design-system-title group-hover:text-primary text-2xl font-bold transition-colors duration-200 lg:text-4xl">
                    {{ post.title }}
                </h4>
